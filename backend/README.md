...
## Project Structure
    ...
    ├── testapiautoconnecto_74959  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_74959`
...
2. Clone this repo and `cd testapiautoconnecto_74959`
